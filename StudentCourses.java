...
public class StudentCourses {
    public static void displayCourseListing(CourseDatabase courseDatabase) {
        ...
        for (Course course : courseDatabase.getCourses().values()) {
            ...
            System.out.println("Code: " + course.getCode() + ", Title: " + course.getTitle() + ", Available Slots: "
                    + availableSlots);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        Course course1 = new Course("CSCI101", "Introduction to Computer Science",
                "An introductory course to programming", 50, "Mon/Wed 10:00 AM");
        Course course2 = new Course("MATH201", "Calculus I", "Introduction to differential calculus", 40,
                "Tue/Thu 2:00 PM");
        Course course3 = new Course("PHYS101", "Physics I", "Classical mechanics and thermodynamics", 60,
                "Mon/Wed/Fri 1:00 PM");
